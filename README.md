...
[![Download Setup Installer](https://img.shields.io/badge/Download-Setup%20Installer-8B5CF6?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/dzmarkets/Academic-Paper-Downloader/releases/download/v2.4.0.9/AcademicPaperDownloader_Setup.exe)
...
- Bumped application version to `v2.4.0.9` in package, installers, configuration, and user-agent string.

### v2.4.0.8
- Extended the tracked journal list by 4000 candidate journals (items 6001-10000) resolved via the open-access pipeline and direct publisher heuristics.
- Bumped application version to `v2.4.0.8` in package, installers, configuration, and user-agent string.

### v2.4.0.7
- Add total number of resolved journals (up to 50k) to console donation info

### v2.4.0.6
- Buy Me a Coffee console integration for local transfers
...
- Bumped application version to `v2.4.0.4` in package, installers, configuration, and user-agent string.
